...
__all__ = ['BiSeNet', 'get_bisenet', 'get_bisenet_resnet18_citys', 'get_bisenet_resnet18_pascal_voc', 'get_bisenet_resnet34_pascal_voc', 'get_bisenet_resnet50_pascal_voc']
...
class ContextPath(nn.Module):
    def __init__(self, backbone='resnet18', pretrained_base=True, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        self.global_context = _GlobalAvgPooling(in_channels_1, inter_channels, norm_layer)

        self.arms = nn.ModuleList(
            [AttentionRefinmentModule(in_channels_1, inter_channels, norm_layer, **kwargs),
             AttentionRefinmentModule(in_channels_2, inter_channels, norm_layer, **kwargs)]
        )
...
def get_bisenet(dataset='citys', backbone='resnet18', pretrained=False, root='~/.torch/models',
    ...
    if pretrained:
        ...
        device = torch.device(0)  #liujin change
...
def get_bisenet_resnet18_pascal_voc(**kwargs):
    return get_bisenet('pascal_voc', 'resnet18', **kwargs)

def get_bisenet_resnet34_pascal_voc(**kwargs):
    return get_bisenet('pascal_voc', 'resnet34', **kwargs)
    
def get_bisenet_resnet50_pascal_voc(**kwargs):
    return get_bisenet('pascal_voc', 'resnet50', **kwargs)
