...
def receiver(host, processid, log_queue):
    ...
    channel.basic_consume(on_message_callback=lambda ch, method, properties, body: image_get_v0(ch, 
                            method, properties, body, processid=processid, log_queue=log_queue),
                          queue='hello',
                          auto_ack=True)
...
def image_get_v0(ch, method, properties, body, processid, log_queue):
...
if __name__ == '__main__':
    ...
    # python3 i13multiple_processor.py --gpu=True --network=yolo3_mobilenet0.25_voc
